...
.. code-block:: shell
    ...
    sudo apt-get --yes install sqlite3 libsqlite3-dev openssl libssl-dev
    sudo apt-get --yes install gdal-bin libproj-dev libgeos-dev libspatialite-dev libsqlite3-mod-spatialite
