# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-02-10 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_registration', models.BooleanField(default=True, help_text='Enable automatic registration of devices', verbose_name='auto-registration enabled')),
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='orgs.Organization', verbose_name='organization')),
            ],
        ),
        migrations.CreateModel(
            name='Template',
            fields=[
                ...
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orgs.Organization', verbose_name='organization')),
            ],
            options={
