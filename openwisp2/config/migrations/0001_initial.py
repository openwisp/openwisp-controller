# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-02-13 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='config_settings', to='orgs.Organization', verbose_name='organization')),
            ],
        ),
        migrations.CreateModel(
            name='Template',
