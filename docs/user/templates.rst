...
Required templates are similar to :ref:`default_templates`
...
:ref:`default_templates` are an incredibly useful tool,
but they're limited: **only one set of default templates can be created**
...
Templates are implemented under the hood by the OpenWISP
