...
When disabled (``False``), a later change to the device's name or MAC
address leaves the existing certificate active: OpenWISP does not revoke
it and does not schedule revocation or reprovisioning.
