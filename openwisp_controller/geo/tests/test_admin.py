...
class TestAdmin(TestAdminMixin, TestGeoMixin, BaseTestAdmin, TestCase):
    ...
    def _create_multitenancy_test_env(self, vpn=False):
        ...
        l1 = self._create_location(name='location1org', type='indoor',
                                   organization=org1)
        l2 = self._create_location(name='location2org', type='indoor',
                                   organization=org2)
        l3 = self._create_location(name='location-inactive', type='indoor',
        ...
        d1 = self._create_object(name='org1-dev',
                                 organization=org1,
                                 key='key1',
                                 mac_address='00:11:22:33:44:56')
        d2 = self._create_object(name='org2-dev',
                                 organization=org2,
                                 key='key2',
                                 mac_address='00:12:22:33:44:56')
        d3 = self._create_object(name='org3-dev',
                                 organization=inactive,
                                 key='key3',
                                 mac_address='00:13:22:33:44:56')
        self._create_object_location(location=l1, floorplan=fl1,
                                     content_object=d1)
        self._create_object_location(location=l2, floorplan=fl2,
                                     content_object=d2)
        self._create_object_location(location=l3, floorplan=fl3,
                                     content_object=d3)
        data = dict(l1=l1, l2=l2, l3_inactive=l3,
                    fl1=fl1, fl2=fl2, fl3_inactive=fl3,
                    org1=org1, org2=org2,
                    inactive=inactive,
                    operator=operator)
        return data
    ...
    def test_location_queryset(self):
        ...
        self._test_multitenant_admin(
            ...
            hidden=[data['l2'].name, data['org2'].name,
                    data['inactive'].name,
    ...
    def test_floorplan_queryset(self):
        ...
        self._test_multitenant_admin(
            ...
            hidden=[data['fl2'], data['org2'].name,
                    data['inactive'].name,
                    data['fl3_inactive']]
        )
