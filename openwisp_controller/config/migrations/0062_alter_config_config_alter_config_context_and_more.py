# Generated by Django 5.2.10 on 2026-02-03 04:20
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.JSONField(
                blank=True,
                default=dict,
                help_text='This field can be used to add meta data for the group or to add "Configuration Variables" to the devices.',
        ...
        migrations.AlterField(
            ...
            field=models.JSONField(
                blank=True,
                default=dict,
                help_text="Group meta data, use this field to store data which is related to this group and can be retrieved via the REST API.",
        ...
        migrations.AlterField(
            ...
            field=models.JSONField(
                blank=True,
                default=dict,
                help_text='This field can be used to add "Configuration Variables" to the devices.',
                verbose_name="Configuration Variables",
            ),
        ),
        migrations.AlterField(
