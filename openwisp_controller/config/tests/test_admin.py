...
class TestAdmin(CreateConfigTemplateMixin, TestAdminMixin,
    ...
    def test_import_api(self):
        ...
        path1 = reverse('share_template', args=[temp1.pk])
        path2 = reverse('share_template', args=[temp2.pk])
        path2 = '{0}?key={1}'.format(path2, temp2.key)
        path3 = reverse('share_template', args=[temp3.pk])
    ...
    def test_search_api(self):
        ...
        self._create_template(name='test-template3',
                              organization=org2)
        path1 = reverse('search_template', args=[org1.name])
        path2 = reverse('search_template', args=[org2.name])
