    ...
    def test_zerotier_api_tasks_notification(
        ...
        with self.subTest(
            ...
            with self.subTest(
                ...
                self.assertEqual(notification.type, "generic_message_error")
                self.assertIn(
            ...
            with self.subTest(
                ...
                self.assertEqual(notification_recovery.type, "generic_message_recovery")
                ...
                self.assertEqual(notification_error.type, "generic_message_error")
                self.assertIn(
