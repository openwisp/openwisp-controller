...
PHONE_METADATA_MF = PhoneMetadata(id='MF', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1[578]|3(?:00|1[0-689])\\d', example_number='15', possible_length=(2, 4)),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1[578]|3(?:00[0-79]|1[0-689]\\d)|(?:118[02-9]|3[2469])\\d\\d', example_number='15', possible_length=(2, 4, 6)),
    short_data=True)
