...
PHONE_METADATA_GY = PhoneMetadata(id='GY', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='91[1-4]', example_number='911', possible_length=(3,)),
    emergency=PhoneNumberDesc(national_number_pattern='91[1-3]', example_number='911', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='0(?:02|(?:17|80)1|444|7(?:[67]7|9)|9(?:0[78]|[2-47]))|1(?:443|5[568])|91[1-4]', example_number='002', possible_length=(3, 4)),
