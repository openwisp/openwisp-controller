...
PHONE_METADATA_TR = PhoneMetadata(id='TR', country_code=90, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='(\\d{3})(\\d)(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['444'], national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['5(?:[0-579]|61)', '5(?:[0-579]|61[06])', '5(?:[0-579]|61[06]1)'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
    ...
    intl_number_format=[NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['512|8[01589]|90']),
        NumberFormat(pattern='(\\d{3})(\\d{3})(\\d{2})(\\d{2})', format='\\1 \\2 \\3 \\4', leading_digits_pattern=['5(?:[0-579]|61)', '5(?:[0-579]|61[06])', '5(?:[0-579]|61[06]1)']),
