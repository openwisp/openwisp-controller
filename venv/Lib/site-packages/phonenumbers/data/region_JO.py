...
PHONE_METADATA_JO = PhoneMetadata(id='JO', country_code=962, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:(?:[2689]|7\\d)\\d|32|427|53)\\d{6}', possible_length=(8, 9)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:427|7(?:[78][0-25-9]|9\\d))\\d{6}', example_number='790123456', possible_length=(9,)),
    ...
    number_format=[NumberFormat(pattern='(\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[2356]|87'], national_prefix_formatting_rule='(0\\1)'),
        ...
        NumberFormat(pattern='(\\d)(\\d{4})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[47]'], national_prefix_formatting_rule='0\\1')],
