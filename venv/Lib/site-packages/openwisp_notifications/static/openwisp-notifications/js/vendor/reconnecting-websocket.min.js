// Reconnecting Websocket library for automatic reconnection if connection is dropped.
      ...
      (this.open = function (b) {
        ...
        var d = h,
          e = setTimeout(function () {
            ((g.debug || a.debugAll) &&
              console.debug("ReconnectingWebSocket", "connection-timeout", g.url),
              (j = !0),
              d.close(),
              (j = !1));
          }, g.timeoutInterval);
        ((h.onopen = function () {
          ...
          (h.onclose = function (c) {
            if ((clearTimeout(e), (h = null), i))
              ...
              var e =
                g.reconnectInterval * Math.pow(g.reconnectDecay, g.reconnectAttempts);
              setTimeout(
                function () {
